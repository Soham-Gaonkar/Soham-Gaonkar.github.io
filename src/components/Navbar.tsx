        ...
        <div className="hidden md:flex items-center gap-8">
              ...
              <Link
                ...
                className={`text-lg md:text-2xl font-semibold px-4 md:px-6 py-1 transition-all duration-300 border-b-2 border-transparent
                  ${location.pathname === link.to
                    ? 'border-black dark:border-slate-200 text-black dark:text-white'
                    : 'hover:border-black hover:dark:border-slate-200 hover:text-black dark:hover:text-white text-gray-700 dark:text-slate-300'}
                `}
          ...
          <div className="flex items-center gap-4 md:gap-6 ml-6">
            ...
            <button
              ...
              className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-black dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors duration-200"
