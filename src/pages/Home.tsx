...
import { trackEmailClick, trackGitHubClick, trackLinkedInClick, trackResumeClick } from '../utils/analytics';
        ...
        <div className="flex flex-col items-center md:items-start w-full text-center md:text-left justify-center max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 mb-7 w-full justify-center md:justify-start">
            ...
            <a
              ...
              onClick={() => trackEmailClick('home_contact_me')}
          ...
          <div className="flex gap-6 md:gap-9 mt-1 md:mt-2 justify-center md:justify-start">
            <a href="https://www.linkedin.com/in/soham-gaonkar-885426280/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" onClick={() => trackLinkedInClick('home_social_icon')} className="text-black dark:text-slate-200 hover:scale-110 transition-transform">
            ...
            <a href="https://github.com/Soham-Gaonkar" target="_blank" rel="noopener noreferrer" aria-label="GitHub" onClick={() => trackGitHubClick('home_social_icon')} className="text-black dark:text-slate-200 hover:scale-110 transition-transform">
            ...
            <a href="mailto:soham.gaonkar@iitgn.ac.in" aria-label="Email" onClick={() => trackEmailClick('home_social_icon')} className="text-black dark:text-slate-200 hover:text-red-600 transition-transform">
