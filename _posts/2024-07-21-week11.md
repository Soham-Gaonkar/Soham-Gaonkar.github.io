...
In the following week, I will add some additional functionality (like a few getter functions to access values and linking base class functions to deriGaonkar classes) and this will complete the entire C++ backend for all trees present in `binary_trees.py` file.
